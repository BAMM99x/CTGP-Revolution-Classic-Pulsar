...
/*
    Second CourseSelect page: the four course buttons list the variants of the track that was
    just clicked (button 0 is the main track, 1..n its variants) instead of the tracks of a cup.
    Everything else on the page - cup strip, title, extern controls - is hidden while it is up.
*/
