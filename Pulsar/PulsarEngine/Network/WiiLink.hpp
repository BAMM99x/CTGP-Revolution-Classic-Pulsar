...
/*
    Quale server contatta questa build. TEST punta al server di VanzaKart e va
    passato al compilatore (-DTEST); senza, la build resta su PROD come prima.
    Il payload e' firmato, quindi dominio e PayloadPublicKey vanno cambiati insieme:
    puntare a un server con la chiave sbagliata da' errore 20917 al login.
*/
#  ifndef TEST
#    define PROD
#  endif
...
#    ifdef TEST
#      define WWFC_DOMAIN "sitodaking.it" // VanzaKart server
#    elif defined(PROD)
...
// VanzaKart payload key (sitodaking.it)
